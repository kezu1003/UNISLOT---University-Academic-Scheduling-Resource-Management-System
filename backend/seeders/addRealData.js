...
// ================= USERS =================
const users = [
  { name: 'Admin User', email: 'admin@sliit.lk', password: 'admin123', role: 'admin' },
  { name: 'Dr. John Smith', email: 'lic@sliit.lk', password: 'lic123', role: 'lic' },
  { name: 'Sarah Johnson', email: 'coord@sliit.lk', password: 'coord123', role: 'coordinator' }
];

// ================= STAFF =================
const staffMembers = [
  { staffId: 'ST001', name: 'Dr. John Smith', email: 'john.smith@sliit.lk', priority: 1, specialization: ['IT', 'SE'], location: 'Malabe', maxWorkload: 20, currentWorkload: 12 },
  { staffId: 'ST002', name: 'Prof. Mary Williams', email: 'mary.williams@sliit.lk', priority: 2, specialization: ['DS', 'IT'], location: 'Malabe', maxWorkload: 18, currentWorkload: 15 },
  { staffId: 'ST003', name: 'Dr. James Brown', email: 'james.brown@sliit.lk', priority: 3, specialization: ['CYBER', 'CS'], location: 'Malabe', maxWorkload: 20, currentWorkload: 8 }
];
